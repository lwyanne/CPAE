...
def draw_from_one_class(num,df,column_to_draw,value):
...
def draw_from_all_class(num,df,column_to_draw):
    cls=df[column_to_draw].unique()
    index=[]
    for i in range(len(cls)):
       index.extend(draw_from_one_class(num,df,column_to_draw,cls[i]))
    return index
